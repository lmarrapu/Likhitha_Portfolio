    ...
    const headerHTML = `
        <header class="header">
            ...
            <div class="header-icons">
                ...
                <a href="https://drive.google.com/file/d/1w8KOqnOUzR17XSbtSLmX3r_oFoR4dIcg/view?usp=sharing" class="download-btn" target="_blank"><i class="fas fa-download"></i> Resume</a>
            </div>
        </header>
    `;
